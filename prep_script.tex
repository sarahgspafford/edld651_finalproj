...
\hypersetup{
  ...
  pdflang={en-EN},
<<<<<<< Updated upstream
  pdfkeywords={minority stress, sexual minorities, LGBQ, health, social connectedness},
=======
...
\caption{ }(\#fig:correlation panels)
\end{figure}
