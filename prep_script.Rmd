...
# Methods
## Participants
This study utilizes data from Project STRIDE: Stress, Identity and Mental Health [@projectstride]. Project STRIDE participants included individuals who had been residing in New York City for a minimum of two years, self-identified as lesbian, gay, bisexual (LGB), or straight, and self-identified as White, Black, or Latino [@projectstride]. Case quota sampling methods were used in order to obtain a sample with adequate representation based on age group, sexual orientation, gender, and race/ethnicity [@projectstridemethod]. For the present study, a subset of data was utilized that included all participants who self-identified as gay, lesbian, queer, bisexual, homosexual, or "other - LGB" and had valid responses to the psychological wellbeing scale at time point 2, discriminatory experiences at time point 1, chronic strain at time point 2, and social connectedness (_n_ = 360). Participants were aged 18-59 years (_M_ = `r mean_age`, _SD_ = `r sd_age`) and the majority identified as gay (_n_ = 160, 44.4%), lesbian (_n_ = 104, 28.8%), or bisexual (_n_ = 63, 17.5%), while 3.3% identified as queer (_n_ = 12), 4.4% identified as homosexual (_n_ = 16), and 1.4% identified as "other LGB" (_n_ = 5). See Table 1 for additional descriptive statistics.
...
```{r mean plot, results="asis",fig.cap = "Experiences of everyday discrimination according to sexual orientation.", fig.align = "center"}
mean_plot <- stridy %>% 
  group_by(sexori) %>% 
  summarize(mean_disc = mean(dis_d_total)) %>% 
  ggplot(aes(sexori, mean_disc)) +
...
```{r correlation panels, echo=FALSE, fig.height=5, fig.width=7, fig.cap = "Correlation panels for all variables included in the model.", fig.align = "center"}
cor_labels <- list(chr_gen_2 = "Chronic Strain", perwellb_2 = "Psychological Wellbeing", dis_d_total = "Discrimination", connect = "Social Connectedness")
...
```{r regression plot, echo=FALSE, fig.cap = "Effect of everyday experiences of discrimination on psychological wellbeing in sexual minorities.", fig.align = "center"}
...
```{r, results='asis'}
```{r lavaan plot, echo=FALSE, fig.cap = "Path model for the effect of discrimination, chronic strain, and social connectedness on psychological wellbeing.", fig.align = "center"}
