...
```{r mean plot, results="asis", fig.height=3, fig.width=5, fig.align = "center"}
mean_plot <- stridy %>% 
  group_by(sexori) %>% 
...
```{r correlation panels, echo=FALSE, fig.height=5, fig.width=7, fig.align = "center"}
cor_labels <- list(chr_gen_2 = "Chronic Strain", perwellb_2 = "Psychological Wellbeing", dis_d_total = "Discrimination", connect = "Social Connectedness")
...
```{r regression plot, echo=FALSE, fig.align = "center"}
...
_Path model for the effect of discrimination, chronic strain, and social connectedness on psychological wellbeing._
```{r lavaan plot, echo=FALSE, fig.align = "center"}
